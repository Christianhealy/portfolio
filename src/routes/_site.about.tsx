...
export const Route = createFileRoute("/_site/about")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "About Christian Healy and his approach to photography and cinematography." },
      { property: "og:title", content: "About — Christian Healy" },
      { property: "og:description", content: "About Christian Healy and his approach to photography and cinematography." },
