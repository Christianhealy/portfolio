...
export const Route = createFileRoute("/_site/about")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "About Atelier Noir and its approach to photography and cinematography.",
      },
    ...
    <main className="mx-auto grid max-w-[1600px] gap-12 px-6 py-20 sm:px-12 sm:py-28 lg:grid-cols-[1.1fr_0.9fr] lg:items-end">
      <Reveal>
        <img
          ...
          alt="Portrait from the Atelier Noir archive"
      ...
      <Reveal delay={140}>
        ...
        <p className="mt-10 max-w-xl text-sm leading-7 text-muted-foreground">
          Atelier Noir creates still and moving images for people, publications and brands. The work
          is grounded in honest moments, considered light and enduring visual language.
        </p>
      </Reveal>
    </main>
  );
